...
const listings = [
  { id: 1, city: 'Beverly Hills', state: 'CA', neighborhood: 'Trousdale Estates', price: 4895000, beds: 4, baths: 5, sqft: '4,820', category: 'Luxury', type: 'City', image: '/assets/realestate-hero.svg', video: '/assets/realestate-hero-preview-v2.mp4', broker: 'Elena Marlow', initials: 'EM', specialty: 'Luxury residences' },
  { id: 2, city: 'Malibu', state: 'CA', neighborhood: 'Carbon Beach', price: 7250000, beds: 5, baths: 6, sqft: '5,640', category: 'Luxury', type: 'Coastal', image: '/assets/realestate-malibu.svg', video: '/assets/realestate-malibu-preview-v2.mp4', broker: 'Marcus Cole', initials: 'MC', specialty: 'Coastal properties' },
  { id: 3, city: 'Scottsdale', state: 'AZ', neighborhood: 'Paradise Valley', price: 3180000, beds: 4, baths: 4.5, sqft: '4,310', category: 'Premium', type: 'Desert', image: '/assets/realestate-scottsdale.svg', video: '/assets/realestate-scottsdale-preview-v2.mp4', broker: 'Sofia Reyes', initials: 'SR', specialty: 'Relocation and Arizona homes' },
  { id: 4, city: 'Austin', state: 'TX', neighborhood: 'The Grove Residences', price: 1285000, beds: 2, baths: 2.5, sqft: '1,780', category: 'Premium', type: 'Urban', image: '/assets/realestate-austin-premium.webp', video: '/assets/realestate-austin-premium-preview-v2.mp4', broker: 'Jordan Lee', initials: 'JL', specialty: 'Investment properties' },
  { id: 5, city: 'Phoenix', state: 'AZ', neighborhood: 'Arcadia Townhomes', price: 535000, beds: 3, baths: 2.5, sqft: '1,690', category: 'Starter', type: 'Townhome', image: '/assets/realestate-phoenix-starter.webp', video: '/assets/realestate-phoenix-starter-preview-v2.mp4', broker: 'Sofia Reyes', initials: 'SR', specialty: 'First-time buyers and relocation' },
  { id: 6, city: 'Mesa', state: 'AZ', neighborhood: 'Desert Willow', price: 415000, beds: 3, baths: 2, sqft: '1,560', category: 'Affordable', type: 'Single-family', image: '/assets/realestate-mesa-affordable.webp', video: '/assets/realestate-mesa-affordable-preview-v2.mp4', broker: 'Sofia Reyes', initials: 'SR', specialty: 'Affordable Arizona homes' },
]
    ...
    <div className="re-page">
      ...
      <main>
        <section className="re-hero re-reveal" id="home">
          <video className="re-hero-image" autoPlay muted loop playsInline poster="/assets/realestate-hero.svg" aria-label="Cinematic preview of the featured Beverly Hills residence"><source src="/assets/realestate-hero-preview-v2.mp4" type="video/mp4" /></video>
